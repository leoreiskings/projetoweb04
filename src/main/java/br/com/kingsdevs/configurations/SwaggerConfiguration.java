...
public class SwaggerConfiguration {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("br.com.kingsdevs")).paths(PathSelectors.ant("/**")).build()
				.apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {

		return new ApiInfo("API para controle de atendimentos", "Sistema Spring Boot API / Banco de Dados - PostGreSQL",
